...
singer = ["카리나", "강해린", "김채원", "우기", "안유진", "카더가든"]
print(singer)
#append remove 값으로 추가/제거
print(singer.append("지젤")) #값을 추가 append()
print(singer.append("루미"))
print(singer.append("리사"))
print(singer)
...
print(singer.insert(1, "박명수")) #insert 삽입 위치 지정 가능
print(singer)

print(singer.insert(3, "카더가든"))
print(singer)
singer.pop(1) #pop 번지수로 삭제 가능
print(singer)
...
print(sport[0:5:2]) #야구 농구 타구 0 2 4
